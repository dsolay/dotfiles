...
local function lsp_status()
    ...
    return err == 0 and "" or err, warn == 0 and "" or warn, info == 0 and "" or info, hint == 0 and "" or hint
end
...
local function update()
    vim.opt.statusline = status()
end

_G.statusline = { status = status, update = update }
