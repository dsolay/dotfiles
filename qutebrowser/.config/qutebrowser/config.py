...
c.aliases = {
    ...
    'pass': 'hint --first inputs ;; spawn --userscript qute-pass --username-target secret --username-pattern "login: (.+)"',
    'useronly': 'hint --first inputs ;; spawn --userscript qute-pass --username-only --username-target secret --username-pattern "login: (.+)"',
    'passonly': 'hint --first inputs ;; spawn --userscript qute-pass --password-only',
    'mpv': 'spawn --userscript view_in_mpv',
    'downloads': 'spawn --userscript open_download',
    'json': 'spawn --userscript json_format',
    'code': 'hint code userscript code_select.py',
    'localhost': 'spawn --userscript localhost list',
    'bookman': 'spawn --userscript /usr/bin/dm-bookman',
    'o': 'open',
    'q': 'quit',
...
## exists.
## Type: List of Url
# c.content.blocking.hosts.list = ['https://raw.githubusercontent.com/StevenBlack/hosts/master/hosts']
...
c.bindings.commands = {
    'normal': {
        ...
        'sd': 'downloads',
        'zl': 'localhost',
        'xa': 'spawn --userscript yt_downloader --mp3',
        'Xa': 'hint links userscript yt_downloader --mp3',
        'xv': 'spawn --userscript yt_downloader',
        'Xv': 'hint links userscript yt_downloader',
        ',ap': 'config-cycle content.user_stylesheets ~/workspace/solarized-everything-css/css/apprentice/apprentice-all-sites.css ""',
        ',dr': 'config-cycle content.user_stylesheets ~/workspace/solarized-everything-css/css/darculized/darculized-all-sites.css ""',
